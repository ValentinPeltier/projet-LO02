...
public class LayoutCircle extends Layout {
    ...
    public boolean moveHorizontally(int offset){
    	...
    	else if(offset == -1)
    	{
    		...
    		if(locations.get(new Location(2, 0)) != null
    			|| locations.get(new Location(1, 1)) != null
				|| locations.get(new Location(0, 2)) != null
				|| locations.get(new Location(1, 3)) != null
				|| locations.get(new Location(2, 4)) != null){isRowEmpty=false;}
    		...
    		if(isRowEmpty)
    		{
    			...
    			locations.replace(new Location(3,1),null);
    			locations.replace(new Location(3,3),null);	
